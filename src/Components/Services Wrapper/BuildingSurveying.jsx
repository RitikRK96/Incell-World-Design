    ...
    <div className="incell-bs-container">
      ...
      <section className="incell-bs-content-section">
        ...
        <p className="incell-bs-main-description">
          Incell World provides expert building surveying services across the UK.
          Our RICS-certified surveyors offer in-depth property surveys, including
          RICS UK Home Buyers’ Reports for a range of clients such as estate agents,
          landlords, and property managers. We ensure unmatched turnaround times and
          competitive pricing.
        </p>
        <p className="incell-bs-secondary-description">
          Our comprehensive RICS Home Buyers Survey includes a thorough examination
          of the property’s condition, providing peace of mind and detailed insights
          into your investment. Each survey covers key areas of concern, culminating
          in a complete RICS-certified report.
        </p>

        {/* Steps Section */}
        <section className="incell-bs-steps-section">
          <h2 className="incell-bs-steps-title">Our 5-Step Surveying Process</h2>
          <div className="incell-bs-steps-container">
            <div className="incell-bs-step">
            ...
            <div className="incell-bs-step">
              ...
              <p className="incell-bs-step-description">
                Our RICS-certified surveyors conduct a thorough physical inspection
                to identify structural issues, defects, and potential risks.
              </p>
            </div>
            <div className="incell-bs-step">
              <h3 className="incell-bs-step-title">3. Data Collection & Analysis</h3>
              <p className="incell-bs-step-description">
                We gather detailed data, including property measurements, materials,
                and condition, followed by rigorous analysis to assess risk factors.
              </p>
            </div>
            <div className="incell-bs-step">
            ...
            <div className="incell-bs-step">
              ...
              <p className="incell-bs-step-description">
                We review the report with you, provide expert insights, and answer
                any questions to ensure you make an informed decision.
              </p>
            </div>
          </div>
        </section>
        ...
        <div className="incell-bs-btn-container">
          ...
          <a href="tel:+441234567890" className="incell-bs-btn incell-bs-call-btn">
            CALL US
          </a>
          <a
